  ...
  return (
    <section className={styles.About}>
        <h1 className={styles.Img}>
          <img src={AboutImg} alt="ファーストビュー" /></h1>
          {/* テキストの親 */}
          <div className={styles.text01}>
      {/* 細かい説明 */}
          <div className={styles.text}>
            <p>都会の喧騒から遥か離れた、絶海の孤島。<br /> 
視界を遮るものは何もなく、ただ圧倒的な青の世界が広がります。</p>
            <p>全室オーシャンビューのプライベートな空間は、<br />
水、木、石といった自然素材が織りなす、研ぎ澄まされた静寂の境地。<br />
 聞こえるのは、穏やかな波音と、自身の内なる声だけ。</p>
 <p>限られたゲストだけに許された、日常からの解放と、<br />
本質的な真の休息がここにあります。</p>
          </div>
          <p className={styles.vertical}>大人のための天空の隠れ家
            </p>
